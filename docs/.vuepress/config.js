module.exports = {
  ...
  themeConfig: {
    ...
    sidebar: {
      ...
      "/template/spa/": ["start", "config", "static"],
      "/template/ssr/": ["start", "config", "router", "mode"],
      "/template/api/": ["start", "config", "jwt"],
    },
    ...
    nav: [
      ...
      },
      {
        ...
        items: [
          {
            text: "全局日志",
            link: "https://github.com/limejs/plugin-global-logger",
          },
          {
            text: "上下文日志",
            link: "https://github.com/limejs/plugin-ctxlog-logger",
          },
          ...
          {
            text: "服务端渲染",
            link: "https://github.com/limejs/plugin-vuessr",
          },
          {
            text: "请求体解析",
            link: "https://github.com/limejs/plugin-body-parser",
          },
        ],
      },
      {
